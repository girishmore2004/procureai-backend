...
// NOTE: the old exports.markPaid (POST /invoices/:id/mark-paid) has been removed.
// It set payment_status straight to 'paid' on an approved invoice, bypassing the
// required sequence: approved -> payment queued -> payment executed -> vendor
// confirms -> order closed. See paymentController.queue / paymentController.execute.
