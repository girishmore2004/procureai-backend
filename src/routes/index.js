...
router.get('/vendor-portal/payments',            verifyVendorToken, vendorAuth.listMyPayments);
router.post('/vendor-portal/payments/:id/confirm', verifyVendorToken, vendorAuth.confirmPayment);
...
router.post('/roles', requirePermission('settings.edit'), users.createRole);
router.delete('/roles/:id', requirePermission('settings.edit'), users.removeRole);
router.patch('/roles/:id/permissions', requirePermission('settings.edit'), users.updateRolePermissions);
router.get('/permissions', requirePermission('users.view'), users.listPermissions);
...
// ── PAYMENTS ──────────────────────────────────────────────────────────
router.get('/payments', requirePermission('payments.view'), payments.list);
router.get('/payments/:id', requirePermission('payments.view'), payments.getOne);
router.post('/payments/:id/execute', requirePermission('payments.approve'), payments.execute);

// ── BILLING ───────────────────────────────────────────────────────────
router.get('/billing', requirePermission('billing.view'), billing.list);
router.post('/billing', requirePermission('billing.create'), billing.create);
router.get('/billing/:id', requirePermission('billing.view'), billing.getOne);
